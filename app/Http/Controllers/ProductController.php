...
class ProductController extends Controller
{
    ...
    /**
     * Muestra los productos y añade opción de búsqueda
     */
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'max_players' => 'required|numeric|min:1|max:999999',
            'min_players' => 'required|numeric|min:0|max:999999',
            ...
            'max_players.required' => 'El número de jugadores es obligatorio.',
            'max_players.numeric' => 'La cantidad de jugadores debe ser un número.',
            'min_players.required' => 'El número de jugadores es obligatorio.',
            'min_players.numeric' => 'La cantidad de jugadores debe ser un número.',
