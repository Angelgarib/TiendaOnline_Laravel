                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        ...
                                        <form action="{{ route('admin.categories.destroy', $category) }}" 
                                              method="POST" 
                                              class="inline-block" 
                                              onsubmit="return confirm('¿Estás seguro de que deseas eliminar este género?');">
                                            @csrf
                                            @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        ...
                                        <p class="text-gray-500 text-lg font-medium">No hay géneros para mostrar</p>
                                        <p class="text-gray-400 text-sm mt-2">Crea tu primer género usando el botón de arriba</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
